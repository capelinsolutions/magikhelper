...
public class MagikHelperConstants {
	...
	public static final String SESSION_ATT_LOGIN="SESSION_ATT_LOGIN";
	
	public static final String SECURITY_KEY="MAGICK-HELPER-KEY-!@#$";
}
