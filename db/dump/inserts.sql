...
VALUES
(1,'SERVICES','Furniture Assembly','Furniture Assembly',1,now(),'System',now(),'System',1);

INSERT INTO `magikhelper`.`application_properties` (`property_id`,`type`,`name`,`value`,`sort_order`,`create_time`,`create_by`,`update_time`,`update_by`,`is_active`)
VALUES
(2,'SERVICES','Cleaning Help','Cleaning Help',2,now(),'System',now(),'System',1);

INSERT INTO `magikhelper`.`application_properties` (`property_id`,`type`,`name`,`value`,`sort_order`,`create_time`,`create_by`,`update_time`,`update_by`,`is_active`)
VALUES
(3,'SERVICES','Moving Help','Moving Help',3,now(),'System',now(),'System',1);

INSERT INTO `magikhelper`.`application_properties` (`property_id`,`type`,`name`,`value`,`sort_order`,`create_time`,`create_by`,`update_time`,`update_by`,`is_active`)
VALUES
(4,'SERVICES','Gardening Help','Gardening Help',4,now(),'System',now(),'System',1);

INSERT INTO `magikhelper`.`application_properties` (`property_id`,`type`,`name`,`value`,`sort_order`,`create_time`,`create_by`,`update_time`,`update_by`,`is_active`)
VALUES
(5,'SERVICES','General Labor Help','General Labor Help',5,now(),'System',now(),'System',1);
...
(`role_id`,`title`,`description`,`create_time`,`create_by`,`update_time`,`update_by`,`is_active`)
VALUES
(1,'ADMIN_ROLE','Role for admins',now(),'SYSTEM',now(),'SYSTEM','1');

INSERT INTO `magikhelper`.`system_role`
(`role_id`,`title`,`description`,`create_time`,`create_by`,`update_time`,`update_by`,`is_active`)
VALUES
(2,'CLIENT_ROLE','Role for clients',now(),'SYSTEM',now(),'SYSTEM','1');

INSERT INTO `magikhelper`.`system_role`
(`role_id`,`title`,`description`,`create_time`,`create_by`,`update_time`,`update_by`,`is_active`)
VALUES
(3,'VENDOR_ROLE','Role for vendors',now(),'SYSTEM',now(),'SYSTEM','1');
/*Sys Roles ends here*/
...
VALUES
(1,now(),'SYSTEM',now(),'SYSTEM','1',1,1);

INSERT INTO `magikhelper`.`user_role`
(`user_role_id`,`create_time`,`create_by`,`update_time`,`update_by`,`is_active`,`user_id`,`role_id`)
VALUES
(2,now(),'SYSTEM',now(),'SYSTEM','1',2,1);

INSERT INTO `magikhelper`.`user_role`
(`user_role_id`,`create_time`,`create_by`,`update_time`,`update_by`,`is_active`,`user_id`,`role_id`)
VALUES
(3,now(),'SYSTEM',now(),'SYSTEM','1',3,2);
