...
!function () {
    ...
    var SPECIAL_CHARS_REGEXP = /([\:\-\_]+(.))/g, MOZ_HACK_REGEXP = /^moz([A-Z])/, Attr2Options = function ($parse, $timeout, NavigatorGeolocation, GeoCoder) {
        var orgAttributes = function (e) {
            ...
            try {
                ...
                try {
                    if (input.match(/^[\+\-]?[0-9\.]+,[ ]*\ ?[\+\-]?[0-9\.]+$/) && (input = "[" + input + "]"), output = JSON.parse(JSONize(input)), output instanceof Array) {
                        var t1stEl = output[0];
                        if (t1stEl.constructor == Object); else if (t1stEl.constructor == Array)output = output.map(function (e) {
            ...
            var t = [];
            if (e["ng-repeat"] || e.ngRepeat); else for (var n in e) {
                var o = e[n];
            ...
            for (var o in e)if (e[o]) {
                ...
                n[o] = toOptionValue(e[o], {scope: t, key: o})
            }
            return n
            ...
            var n = {}, o = function (e) {
                ...
                var n = t.match(/([^\(]+)\(([^\)]*)\)/), o = n[1], r = n[2].replace(/event[ ,]*/, ""), i = e.$eval("[" + r + "]");
                return function (t) {
                    function n(e, t) {
                        return e[t]
                    }
                ...
                try {
                    ...
                    for (var a in i)if (i[a]) {
                        ...
                        if ("string" == typeof s ? s = s.toUpperCase() : "mapTypeIds" === a && (s = s.map(function (e) {
                            ...
                            var c = n.charAt(0).toUpperCase() + n.slice(1), p = c.replace(/Options$/, "") + "Style";
                            i[a] = google.maps[p][s]
    ...
    var e = function (e) {
        var t = function (t, n) {
            n = n || t.getCenter();
            var o = e.defer(), r = new google.maps.StreetViewService;
        ...
        return {getPanorama: t, setPanorama: n}
    };
    ...
    return {
        restrict: "E", require: "^map", link: function (e, o, r, i) {
            var a = t.orgAttributes(o), s = t.filter(r), c = t.getOptions(s), p = t.getEvents(e, s), u = n(c, p);
    ...
    return {
        restrict: "E", require: "^map", link: function (e, o, r, i) {
            var a = t.orgAttributes(o), s = t.filter(r), c = t.getOptions(s), p = t.getEvents(e, s), u = n(c, p);
            i.addObject("cloudLayers", u), i.observeAttrSetObj(a, r, u), o.bind("$destroy", function () {
                i.deleteObject("cloudLayers", u)
            })
        }
    }
    ...
    return {
        restrict: "E", require: "^map", link: function (e, o, r, i) {
            o.css("display", "none");
            var a = (n.orgAttributes(o), n.filter(r)), s = n.getOptions(a, e), c = n.getEvents(e, a), p = t(o.html().trim())(e), u = p[0];
    ...
    var e = function (e, t) {
        ...
        var o = t, r = new google.maps.DirectionsService, i = function (e, t) {
            var o = t;
            ...
            var s = o.orgAttributes(n), c = o.filter(r), p = o.getOptions(c), u = o.getEvents(t, c), l = o.getAttrsToObserve(s), g = e(p, u);
            a.addObject("directionsRenderers", g), l.forEach(function (e) {
                !function (e) {
                    r.$observe(e, function (t) {
                        if (p[e] !== t) {
                            var n = o.toOptionValue(t, {key: e});
                            p[e] = n, i(g, p)
                        }
                    })
                }(e)
        ...
        return {restrict: "E", require: "^map", link: a}
    };
    ...
    var t = e;
    return {
        restrict: "E", require: "^map", link: function (e, n, o, r) {
            var i = (t.orgAttributes(n), t.filter(o)), a = t.getOptions(i), s = t.getControlOptions(i), c = t.getEvents(e, i), p = new google.maps.drawing.DrawingManager({
            ...
            for (var u in c)google.maps.event.addListener(p, u, c[u]);
    ...
    return {
        restrict: "E", require: "^map", link: function (e, o, r, i) {
            var a = t.filter(r), s = t.getOptions(a), c = t.getEvents(e, a, c), p = n(s, c);
    ...
    return {
        restrict: "E", require: "^map", link: function (e, o, r, i) {
            var a = n.filter(r), s = n.getOptions(a);
    ...
    var e = function (e, t, n, o) {
        var r = e, i = function (e, o, r) {
            ...
            return i.__template = s.replace(/\s?ng-non-bindable[='"]+/, ""), i.__compile = function (e, n) {
                ...
                n(function () {
                    var n = i.__template;
                    i.__compile(t, o), o && o.getPosition ? i.open(e, o) : o && o instanceof google.maps.LatLng ? (i.open(e), i.setPosition(o)) : i.open(e), i.__template = n
                })
            }, i
        }, a = function (e, t, n, a) {
            t.css("display", "none");
            var s, c = r.orgAttributes(t), p = r.filter(n), u = r.getOptions(p, e), l = r.getEvents(e, p);
            !u.position || u.position instanceof google.maps.LatLng || (s = u.position);
            var g = i(u, l, t);
            s && a.getGeoLocation(s).then(function (t) {
                ...
                var r = a.map.infoWindows[n], i = o ? o : this.getPosition ? this : null;
                r.__open(a.map, e, i)
    ...
    var t = e;
    return {
        restrict: "E", require: "^map", link: function (e, n, o) {
            var r = t.filter(o), i = t.getOptions(r), a = t.getEvents(e, r, a);
    ...
    var t = function (t, n, o) {
        var r = t, i = function (t, i, a, s) {
            var c = r.orgAttributes(i);
            t.google = google;
            var p = document.createElement("div");
            p.style.width = "100%", p.style.height = "100%", i.prepend(p), "block" != e(i[0], "display") && i.css("display", "block"), e(i[0], "height").match(/^(0|auto)/) && i.css("height", "300px");
            var u = function (e, r) {
                var i = new google.maps.Map(p, {});
                i.markers = {}, i.shapes = {}, n(function () {
                    google.maps.event.trigger(i, "resize")
                }), e.zoom = e.zoom || 15;
                var u = e.center;
                u ? u instanceof google.maps.LatLng || (delete e.center, s.getGeoLocation(u).then(function (e) {
                    i.setCenter(e);
                    var n = a.geoCallback;
                    n && o(n)(t)
                }, function () {
                ...
                for (var l in r)l && google.maps.event.addListener(i, l, r[l]);
                s.observeAttrSetObj(c, a, i), s.map = i, s.addObjects(s._objects), t.map = i, t.map.scope = t, google.maps.event.addListenerOnce(i, "idle", function () {
                    t.$emit("mapInitialized", i)
                }), t.maps = t.maps || {}, t.maps[g.id || Object.keys(t.maps).length] = i, t.$emit("mapsInitialized", t.maps)
            }, l = r.filter(a), g = r.getOptions(l, t), d = r.getControlOptions(l), v = angular.extend(g, d), f = r.getEvents(t, l);
            a.initEvent ? t.$on(a.initEvent, function () {
                !s.map && u(v, f)
            }) : u(v, f)
        };
        return {restrict: "AE", controller: "MapController", link: i}
    };
    angular.module("ngMap").directive("map", ["Attr2Options", "$timeout", "$parse", t])
}(), function () {
    "use strict";
    var e = function (e, t, n, o) {
        var r = o, i = this, a = function (e, t, n) {
            e.$observe(t, function (e) {
                if (e) {
                    var o = r.camelCase("set-" + t), a = r.toOptionValue(e, {key: t});
        ...
        this.map = null, this._objects = [], this.addObject = function (e, t) {
            ...
            return !o || o.match(/^current/i) ? t.getCurrentPosition().then(function (e) {
                ...
                r.reject(e)
            }) : n.geocode({address: o}).then(function (e) {
    ...
    var e = function (e, t) {
        ...
        var o = t, r = function (t, r, i, a) {
            var s, c = o.orgAttributes(r), p = o.filter(i), u = o.getOptions(p, t), l = o.getEvents(t, p);
            u.position instanceof google.maps.LatLng || (s = u.position);
            var g = e(u, l);
            a.addObject("markers", g), s && a.getGeoLocation(s).then(function (e) {
                g.setPosition(e), u.centered && g.map.setCenter(e);
                var o = i.geoCallback;
                o && n(o)(t)
        ...
        return {restrict: "E", require: "^map", link: r}
    };
    ...
    "use strict";
    var e = function (e, t) {
        var n = e, o = function (e, o, r, i) {
            var a = n.filter(r), s = n.getOptions(a), c = n.getEvents(e, a), p = new google.maps.places.Autocomplete(o[0], s);
            for (var u in c)google.maps.event.addListener(p, u, c[u]);
    ...
    var e = function (e) {
        ...
        var o, r = t.name;
        if (delete t.name, t.icons)for (var i = 0; i < t.icons.length; i++) {
            var a = t.icons[i];
        ...
        switch (r) {
            ...
            case"groundOverlay":
            case"image":
                var s = t.url, c = e(t.bounds), p = {opacity: t.opacity, clickable: t.clickable, id: t.id};
                o = new google.maps.GroundOverlay(s, c, p)
        }
        for (var u in n)n[u] && google.maps.event.addListener(o, u, n[u]);
        return o
    }, n = function (e, n) {
        var o = e, r = function (e, r, i, a) {
            var s, c, p = o.orgAttributes(r), u = o.filter(i), l = o.getOptions(u), g = o.getEvents(e, u);
            c = l.name, l.center instanceof google.maps.LatLng || (s = l.center);
            var d = t(l, g);
            a.addObject("shapes", d), s && "circle" == c && a.getGeoLocation(s).then(function (t) {
                d.setCenter(t), d.centered && d.map.setCenter(t);
                var o = i.geoCallback;
                o && n(o)(e)
            }), a.observeAttrSetObj(p, i, d), r.bind("$destroy", function () {
    ...
    var e = function (e) {
        var t = e, n = function (e, t, n) {
            ...
            var i = (t.orgAttributes(o), t.filter(r)), a = t.getOptions(i), s = t.getControlOptions(i), c = angular.extend(a, s), p = t.getEvents(e, i);
            e.$on("mapInitialized", function (e, t) {
                var o = n(t, c, p);
        ...
        return {restrict: "E", require: "^map", link: o}
    };
    ...
    return {
        restrict: "E", require: "^map", link: function (e, o, r, i) {
            var a = t.orgAttributes(o), s = t.filter(r), c = t.getOptions(s), p = t.getEvents(e, s), u = n(c, p);
            i.addObject("weatherLayers", u), i.observeAttrSetObj(a, r, u), o.bind("$destroy", function () {
                i.deleteObject("weatherLayers", u)
            })
        }
    }
}]);