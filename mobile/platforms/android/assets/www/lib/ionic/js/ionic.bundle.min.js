...
!function () {
    ...
    function r(t) {
        if (!t.isIonicTap && !_(t)) {
            if (Y)return t.stopPropagation(), ionic.tap.isTextInput(t.target) && W === t.target || /^(select|option)$/i.test(t.target.tagName) || t.preventDefault(), !1;
            X = !1, F = ionic.tap.pointerCoord(t), e("mousemove"), ionic.activator.start(t)
        }
    }

    function o(n) {
        return Y ? (n.stopPropagation(), n.preventDefault(), !1) : _(n) || /^(select|option)$/i.test(n.target.tagName) ? !1 : (v(n) || t(n), e("mousemove", !1), ionic.activator.end(), void(X = !1))
    }
    ...
    function d() {
        Y = !0, clearTimeout(z), z = setTimeout(function () {
            Y = !1
        }, 2e3)
    }
    ...
    function h(e) {
        $ = null;
        var t = !1;
        "SELECT" == e.tagName ? (n("mousedown", e, 0, 0), e.focus && e.focus(), t = !0) : g() === e ? t = !0 : /^(input|textarea)$/i.test(e.tagName) || e.isContentEditable ? (t = !0, e.focus && e.focus(), e.value = e.value, Y && ($ = e)) : f(), t && (g(e), ionic.trigger("ionic.focusin", {target: e}, !0))
    }
    ...
    function p(e) {
        Y && ionic.tap.isTextInput(g()) && ionic.tap.isTextInput($) && $ !== e.target && ($.focus(), $ = null), ionic.scroll.isScrolling = !1
    }
    ...
    function g(e) {
        return arguments.length && (H = e), H || document.activeElement
    }
    ...
    function w(e) {
        e.target && !e.target.readOnly && ionic.tap.isTextInput(e.target) && !ionic.tap.isDateInput(e.target) && G(e.target) && (document.addEventListener("keydown", M, !1), document.body.scrollTop = 0, document.body.querySelector(".scroll-content").scrollTop = 0, j = e.target, y(e))
    }
    ...
    function y(e) {
        clearTimeout(J), clearTimeout(K), J = setTimeout(function () {
            if (!(tt + 350 > Date.now())) {
                tt = Date.now();
                var t, n = j.getBoundingClientRect(), i = 0;
    ...
    function D(e, t, n, i, r) {
        ...
        return o.hasPlugin = P(), o.contentHeight = i - r, o.isElementUnderKeyboard = o.elementBottom > o.contentHeight, ionic.keyboard.isOpen = !0, j = e, ionic.trigger("scrollChildIntoView", o, !0), ionic.requestAnimationFrame(function () {
    ...
    window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.0.0-rc.0", function (e) {
        ...
        var s, a = "ios", l = "android", c = "windowsphone", u = n.requestAnimationFrame, d = n.Platform = {
            ...
            fullScreen: function (e, i) {
                d.isFullScreen = e !== !1, n.DomUtil.ready(function () {
                    u(function () {
                        for (var e = t.getElementsByClassName("pane"), n = 0; n < e.length; n++)e[n].style.height = e[n].offsetHeight + "px";
    ...
    var k, H, Y, z, X, F, $, W, U = "touchmove", q = 12, B = 50, Z = {
        click: i,
        mousedown: r,
        mouseup: o,
        mousemove: s,
    ...
    ionic.tap = {
                ...
                n > 0 && 45 > n || t.requestAnimationFrame(function () {
                    if (!(t.scroll && t.scroll.isScrolling || t.tap.requiresNativeClick(e.target))) {
                        for (var n, r = e.target, s = 0; 6 > s && (r && 1 === r.nodeType); s++) {
                            if (n && r.classList.contains("item")) {
                                n = r;
                                break
                            }
                            ...
                            if ("ION-CONTENT" == r.tagName || r.classList.contains("pane") || "BODY" == r.tagName)break;
                            r = r.parentElement
                        }
        ...
        e.Utils = {
            arrayMove: function (e, t, n) {
                ...
                if (e && e.$root !== e) {
                    var t = e.$parent;
                    e.$$disconnected = !0, e.$broadcast("$ionic.disconnectScope"), t.$$childHead === e && (t.$$childHead = e.$$nextSibling), t.$$childTail === e && (t.$$childTail = e.$$prevSibling), e.$$prevSibling && (e.$$prevSibling.$$nextSibling = e.$$nextSibling), e.$$nextSibling && (e.$$nextSibling.$$prevSibling = e.$$prevSibling), e.$$nextSibling = e.$$prevSibling = null
                }
            }, reconnectScope: function (e) {
                if (e && e.$root !== e && e.$$disconnected) {
                    var t = e.$parent;
                    e.$$disconnected = !1, e.$broadcast("$ionic.reconnectScope"), e.$$prevSibling = t.$$childTail, t.$$childHead ? (t.$$childTail.$$nextSibling = e, t.$$childTail = e) : t.$$childHead = t.$$childTail = e
                }
    ...
    var j, K, J, Q, et = C(), tt = 0, nt = "keyboard-open", it = "scroll";
    ionic.keyboard = {
        isOpen: !1, height: null, landscape: !1, hide: function () {
            clearTimeout(J), clearTimeout(K), clearTimeout(Q), ionic.keyboard.isOpen = !1, ionic.trigger("resetScrollView", {target: j}, !0), ionic.requestAnimationFrame(function () {
...
!function () {
        ...
        function a(a, c, s, l, u) {
            function d() {
                return S || (S = new e({
                        ...
                        heightData: B,
                        widthData: I,
                        forceRefreshImages: !(!f(s.forceRefreshImages) || "false" === s.forceRefreshImages),
                        keyExpression: k,
                        renderBuffer: V,
                        scope: a,
                        scrollView: l.scrollView,
                        transclude: u
                    }))
            }

            function h() {
                var e = m.__clientHeight, t = m.__clientWidth;
                t && e && (h.height !== e || h.width !== t) && (h.height = e, h.width = t, p())
            }

            function p() {
                if ((B.computed || I.computed) && g(), B.computed) {
                    if (B.value = x.height, !B.value)throw new Error('collection-repeat tried to compute the height of repeated elements "' + b + '", but was unable to. Please provide the "item-height" attribute. http://ionicframework.com/docs/api/directive/collectionRepeat/')
                } else!B.dynamic && B.getValue && (B.value = B.getValue());
                if (I.computed) {
                    if (I.value = x.width, !I.value)throw new Error('collection-repeat tried to compute the width of repeated elements "' + b + '", but was unable to. Please provide the "item-width" attribute. http://ionicframework.com/docs/api/directive/collectionRepeat/')
                } else!I.dynamic && I.getValue && (I.value = I.getValue());
                d().refreshLayout()
            }
            ...
            function v(e, n) {
                if (e) {
                    ...
                    if (n.attrValue = e, a) {
                        ...
                        if (e.indexOf("%") > -1) {
                            var s = c / 100;
                            n.getValue = n === B ? function () {
                                return Math.floor(s * m.__clientHeight)
                            } : function () {
                                return Math.floor(s * m.__clientWidth)
                            }
                        } else n.value = c
                    } else n.dynamic = !0, n.getValue = n === B ? function (e, t) {
                        var n = i(e, t);
                        return n.charAt && "%" === n.charAt(n.length - 1) ? Math.floor(parseInt(n) / 100 * m.__clientHeight) : parseInt(n)
                    } : function (e, t) {
                        var n = i(e, t);
                        return n.charAt && "%" === n.charAt(n.length - 1) ? Math.floor(parseInt(n) / 100 * m.__clientWidth) : parseInt(n)
                    }
                }
            }

            function g() {
                R || u(H = a.$new(), function (e) {
                    e[0].removeAttribute("collection-repeat"), R = e[0]
                }), H[k] = (T(a) || [])[0], o.$$phase || H.$digest(), w.appendChild(R);
                var e = n.getComputedStyle(R);
                x.width = parseInt(e.width), x.height = parseInt(e.height), w.removeChild(R)
            }

            var m = l.scrollView, $ = c[0], w = angular.element('<div class="collection-repeat-container">')[0];
            if ($.parentNode.replaceChild(w, $), m.options.scrollingX && m.options.scrollingY)throw new Error("collection-repeat expected a parent x or y scrollView, not an xy scrollView.");
            var b = s.collectionRepeat, y = b.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);
            if (!y)throw new Error("collection-repeat expected expression in form of '_item_ in _collection_[ track by _id_]' but got '" + s.collectionRepeat + "'.");
            var S, k = y[1], C = y[2], T = t(C), B = {}, I = {}, x = {}, A = s.itemRenderBuffer || s.collectionBufferSize, V = angular.isDefined(A) ? parseInt(A) : E, P = s.itemHeight || s.collectionItemHeight, D = s.itemWidth || s.collectionItemWidth;
            P || D ? (P ? v(P, B) : B.computed = !0, D || (D = '"100%"'), v(D, I)) : B.computed = I.computed = !0;
            var L = angular.element(m.__content.querySelector(".collection-repeat-after-container"));
            if (!L.length) {
                var M = !1, N = [].filter.call(m.__content.childNodes, function (e) {
                    return ionic.DomUtil.contains(e, w) ? (M = !0, !1) : M
                });
                L = angular.element('<span class="collection-repeat-after-container">'), m.options.scrollingX && L.addClass("horizontal"), L.append(N), m.__content.appendChild(L[0])
            }
            i(p), l.$element.one("scroll.init", p);
            var _ = ionic.animationFrameThrottle(h);
            angular.element(n).on("resize", _), a.$on("$destroy", function () {
                angular.element(n).off("resize", _), l.$element && l.$element.off("scroll.init", p), R && R.parentNode && R.parentNode.removeChild(R), H && H.$destroy(), H = R = null, S && S.destroy(), S = null
            }), a.$watchCollection(T, function (e) {
                if (e || (e = []), !angular.isArray(e))throw new Error("collection-repeat expected an array for '" + C + "', but got a " + typeof value);
                r(function () {
                    d().refreshData(e), e.length && p()
                }, 0, !1)
            });
            var R, H
        }
    ...
    function t(e, t, n) {
        ...
        return function (t) {
            ...
            function a(t) {
                if (!a.destroyed) {
                    var n, i, r, l, u = Q.getScrollValue(), d = u + Q.scrollPrimarySize;
                    Q.updateRenderRange(u, d), F = Math.max(0, F - k), W = Math.min(I.length - 1, W + k);
                    for (n in K)(F > n || n > W) && (i = K[n], delete K[n], j.push(i), i.isShown = !1, i.scope.$broadcast("$collectionRepeatChange"));
                    for (n = F; W >= n; n++)n >= I.length || K[n] && !t || (i = K[n] || (K[n] = j.length ? j.pop() : G.length ? G.shift() : new s), Z.push(i), i.isShown = !0, l = i.scope, l.$index = n, l[S] = I[n], l.$first = 0 === n, l.$last = n === I.length - 1, l.$middle = !(l.$first || l.$last), l.$odd = !(l.$even = 0 === (1 & n)), l.$$disconnected && ionic.Utils.reconnectScope(i.scope), r = Q.getDimensions(n), (i.secondaryPos !== r.secondaryPos || i.primaryPos !== r.primaryPos) && (i.node.style[ionic.CSS.TRANSFORM] = z.replace(R, i.primaryPos = r.primaryPos).replace(H, i.secondaryPos = r.secondaryPos)), (i.secondarySize !== r.secondarySize || i.primarySize !== r.primarySize) && (i.node.style.cssText = i.node.style.cssText.replace(A, O.replace(R, (i.primarySize = r.primarySize) + 1).replace(H, i.secondarySize = r.secondarySize))));
                    for (W === I.length - 1 && (r = Q.getDimensions(I.length - 1) || o, m.style[ionic.CSS.TRANSFORM] = z.replace(R, r.primaryPos + r.primarySize).replace(H, 0)); j.length;)i = j.pop(), ionic.Utils.disconnectScope(i.scope), G.push(i), i.node.style[ionic.CSS.TRANSFORM] = "translate3d(-9999px,-9999px,0)", i.primaryPos = i.secondaryPos = null;
                    if (w)for (n = 0, ii = Z.length; n < ii && (i = Z[n]); n++)if (i.images)for (var f, h = 0, p = i.images.length; p > h && (f = i.images[h]); h++) {
                        var v = f.src;
                        f.src = x, f.src = v
                    }
                    if (t)for (var g = e.$$phase; Z.length;)i = Z.pop(), g || i.scope.$digest(); else c()
                }
            }

            function c() {
                var t, i;
                c.running || (c.running = !0, n(function o() {
                    if (i = Z.length) {
                        for (var r = e.$$phase, a = Math.floor(i / 1.25) || 1; a && Z.length;)t = Z.pop(), t.isShown && (a--, r || t.scope.$digest());
                        n(o)
                    } else c.running = !1
                }))
            }
            ...
            function s() {
                var e = this;
                this.scope = C.$new(), this.id = "item" + J++, B(this.scope, function (t) {
            ...
            function l() {
                this.getItemPrimarySize = P, this.getItemSecondarySize = L, this.getScrollValue = function () {
                    return Math.max(0, Math.min(T.__scrollTop - U, T.__maxScrollTop - U - q))
                }, this.refreshDirection = function () {
                    this.scrollPrimarySize = T.__clientHeight, this.scrollSecondarySize = T.__clientWidth, this.estimatedPrimarySize = v, this.estimatedSecondarySize = g, this.estimatedItemsAcross = N && Math.floor(T.__clientWidth / g) || 1
                }
            }

            function u() {
                this.getItemPrimarySize = L, this.getItemSecondarySize = P, this.getScrollValue = function () {
                    return Math.max(0, Math.min(T.__scrollLeft - U, T.__maxScrollLeft - U - q))
                }, this.refreshDirection = function () {
                    this.scrollPrimarySize = T.__clientWidth, this.scrollSecondarySize = T.__clientHeight, this.estimatedPrimarySize = g, this.estimatedSecondarySize = v, this.estimatedItemsAcross = N && Math.floor(T.__clientHeight / v) || 1
                }
            }
            ...
            function h() {
                this.getContentSize = function () {
                    return this.getEstimatedPrimaryPos(I.length - 1) + this.estimatedPrimarySize + U + q
                };
                var e = {};
                this.getDimensions = function (t) {
                    ...
                    F = Math.max(0, this.getEstimatedIndex(e)), W = Math.min(I.length - 1, this.getEstimatedIndex(t) + this.estimatedItemsAcross - 1), Y = Math.max(0, this.getEstimatedPrimaryPos(F)), X = this.getEstimatedPrimaryPos(W) + this.estimatedPrimarySize
                }
            }
            ...
            function p() {
                function e(e) {
                    var t, i, a;
                    for (t = Math.max(0, n); e >= t && (a = l[t]); t++)i = l[t - 1] || o, a.primarySize = r.getItemPrimarySize(t, I[t]), a.secondarySize = r.scrollSecondarySize, a.primaryPos = i.primaryPos + i.primarySize, a.secondaryPos = 0
                }

                function t(e) {
                    var t, i, a;
                    for (t = Math.max(n, 0); e >= t && (a = l[t]); t++)i = l[t - 1] || o, a.secondarySize = Math.min(r.getItemSecondarySize(t, I[t]), r.scrollSecondarySize), a.secondaryPos = i.secondaryPos + i.secondarySize, 0 === t || a.secondaryPos + a.secondarySize > r.scrollSecondarySize ? (a.rowStartIndex = t, a.secondaryPos = 0, a.primarySize = r.getItemPrimarySize(t, I[t]), a.primaryPos = i.primaryPos + i.primarySize) : (a.rowStartIndex = i.rowStartIndex, a.primarySize = i.primarySize, a.primaryPos = i.primaryPos)
                }

                var n, r = this, a = M ? function () {
                    T.setDimensions(null, null, null, r.getContentSize(), !0)
                } : function () {
                    T.setDimensions(null, null, r.getContentSize(), null, !0)
                }, c = ionic.debounce(a, 25, !0), s = N ? t : e, l = [];
                this.getContentSize = function () {
                    var e = l[n] || o;
                    return (e.primaryPos + e.primarySize || 0) + this.getEstimatedPrimaryPos(I.length - n - 1) + U + q
                }, this.onDestroy = function () {
                    l.length = 0
                }, this.onRefreshData = function () {
                    for (i = l.length, len = I.length; i < len; i++)l.push({});
                    n = -1
                }, this.onRefreshLayout = function () {
                    n = -1
                }, this.getDimensions = function (e) {
                    return e = Math.min(e, I.length - 1), e > n && (e > .9 * I.length ? (s(I.length - 1), n = I.length - 1, a()) : (s(e), n = e, c())), l[e]
                };
                var u = -1, d = -1;
                this.updateRenderRange = function (e, t) {
                    var n, i, o;
                    if (this.getDimensions(2 * this.getEstimatedIndex(t)), -1 === u || 0 === e)n = 0; else if (e >= d)for (n = u, i = I.length; i > n && !((o = this.getDimensions(n)) && o.primaryPos + o.primarySize >= e); n++); else for (n = u; n >= 0; n--)if ((o = this.getDimensions(n)) && o.primaryPos <= e) {
                        n = N ? o.rowStartIndex : n;
                        break
                    }
                    F = Math.min(Math.max(0, n), I.length - 1), Y = -1 !== F ? this.getDimensions(F).primaryPos : -1;
                    var r;
                    for (n = F + 1, i = I.length; i > n; n++)if ((o = this.getDimensions(n)) && o.primaryPos + o.primarySize > t) {
                        if (N)for (r = o; i - 1 > n && (o = this.getDimensions(n + 1)).primaryPos === r.primaryPos;)n++;
                        break
                    }
                    W = Math.min(n, I.length - 1), X = -1 !== W ? (o = this.getDimensions(W)).primaryPos + o.primarySize : -1, d = e, u = F
                }
            }

            var v, g, m = t.afterItemsNode, $ = t.containerNode, w = t.forceRefreshImages, b = t.heightData, y = t.widthData, S = t.keyExpression, k = t.renderBuffer, C = t.scope, T = t.scrollView, B = t.transclude, I = [], E = {}, V = b.getValue || function () {
                    return b.value
                }, P = function (e, t) {
                return E[S] = t, E.$index = e, V(C, E)
            }, D = y.getValue || function () {
                    return y.value
                }, L = function (e, t) {
                return E[S] = t, E.$index = e, D(C, E)
            }, M = !!T.options.scrollingY, N = M ? y.dynamic || y.value !== T.__clientWidth : b.dynamic || b.value !== T.__clientHeight, _ = !b.dynamic && !y.dynamic, R = "PRIMARY", H = "SECONDARY", z = M ? "translate3d(SECONDARYpx,PRIMARYpx,0)" : "translate3d(PRIMARYpx,SECONDARYpx,0)", O = M ? "height: PRIMARYpx; width: SECONDARYpx;" : "height: SECONDARYpx; width: PRIMARYpx;", U = 0, q = 0, F = -1, W = -1, X = -1, Y = -1, G = [], j = [], Z = [], K = {}, J = 0, Q = M ? new l : new u;
            (N ? d : f).call(Q), (_ ? h : p).call(Q);
            var et = M ? "getContentHeight" : "getContentWidth", tt = T.options[et];
            T.options[et] = angular.bind(Q, Q.getContentSize), T.__$callback = T.__callback, T.__callback = function (e, t, n, i) {
                var o = Q.getScrollValue();
                (-1 === F || o + Q.scrollPrimarySize > X || Y > o) && a(), T.__$callback(e, t, n, i)
            };
            var nt = !1, it = !1;
            this.refreshLayout = function () {
                v = P(0, I[0]), g = L(0, I[0]);
                var e = getComputedStyle(m) || {}, t = m.firstElementChild && getComputedStyle(m.firstElementChild) || {}, n = m.lastElementChild && getComputedStyle(m.lastElementChild) || {};
                q = (parseInt(e[M ? "height" : "width"]) || 0) + (t && parseInt(t[M ? "marginTop" : "marginLeft"]) || 0) + (n && parseInt(n[M ? "marginBottom" : "marginRight"]) || 0), U = 0;
                var i = $;
                do U += i[M ? "offsetTop" : "offsetLeft"]; while (ionic.DomUtil.contains(T.__content, i = i.offsetParent));
                if ((Q.onRefreshLayout || angular.noop)(), Q.refreshDirection(), !nt)for (var o = Math.max(20, 3 * k), a = 0; o > a; a++)G.push(new s);
                nt = !0, nt && it && r()
            }, this.refreshData = function (e) {
                I = e, (Q.onRefreshData || angular.noop)(), it = !0, nt && it && (T.resize(), r())
            }, this.destroy = function () {
                a.destroyed = !0, G.forEach(function (e) {
                    e.scope.$destroy(), e.scope = e.element = e.node = e.images = null
                }), G.length = Z.length = j.length = 0, K = {}, T.options[et] = tt, T.__callback = T.__$callback, T.resize(), (Q.onDestroy || angular.noop)()
            }
        }
    }
    ...
    l.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", function (e, t, n, i, o, r, a) {
        ...
        return L.prototype.initialize = function (e) {
            ...
            register: function (e, t) {
                var i, a, l, u = v(), m = f(e), L = D.currentView, M = D.backView, N = D.forwardView, _ = null, R = null, H = V, z = m.historyId, O = n.url();
                if ($ !== u && ($ = u, P++), y)_ = y.viewId, R = y.action, H = y.direction, y = null; else if (M && M.stateId === u)_ = M.viewId, z = M.historyId, R = C, M.historyId === L.historyId ? H = B : L && (H = A, i = d(M.historyId), i && i.parentHistoryId === L.historyId ? H = x : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (H = E))); else if (N && N.stateId === u)_ = N.viewId, z = N.historyId, R = T, N.historyId === L.historyId ? H = I : L && (H = A, L.historyId === m.parentHistoryId ? H = x : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (H = E))), i = h(e), N.historyId && i.scope && (i.scope.$historyId = N.historyId, z = N.historyId); else if (L && L.historyId !== z && m.cursor > -1 && m.stack.length > 0 && m.cursor < m.stack.length && m.stack[m.cursor].stateId === u) {
                    var U = m.stack[m.cursor];
                    _ = U.viewId, z = U.historyId, R = C, H = E, i = d(L.historyId), i && i.parentHistoryId === z ? H = A : (i = d(z), i && i.parentHistoryId === L.historyId && (H = x)), i = c(U.backViewId), i && U.historyId !== i.historyId && (m.stack[m.cursor].backViewId = L.viewId)
                } else {
                    ...
                    if (_ = ionic.Utils.nextUid(), L) {
                        if (L.forwardViewId = _, R = k, N && L.stateId !== N.stateId && L.historyId === N.historyId && (i = d(N.historyId))) {
                    ...
                    2 > P && (H = V), D.views[_] = this.createView({
                        viewId: _,
                        ...
                        stateParams: g(),
                        url: O
                    }), m.stack.push(D.views[_])
                }
                if (o.cancel(b), w) {
                    if (w.disableAnimate && (H = V), w.disableBack && (D.views[_].backViewId = null), w.historyRoot) {
                        for (a = 0; a < m.stack.length; a++)m.stack[a].viewId === _ ? (m.stack[a].index = 0, m.stack[a].backViewId = m.stack[a].forwardViewId = null) : delete D.views[m.stack[a].viewId];
                        m.stack = [D.views[_]]
                    }
                    w = null
                }
                if (p(_), D.backView && z == D.backView.historyId && u == D.backView.stateId && O == D.backView.url)for (a = 0; a < m.stack.length; a++)if (m.stack[a].viewId == _) {
                    R = "dupNav", H = V, a > 0 && (m.stack[a - 1].forwardViewId = null), D.forwardView = null, D.currentView.index = D.backView.index, D.currentView.backViewId = D.backView.backViewId, D.backView = s(D.backView), m.stack.splice(a, 1);
                    break
                }
    ...
    l.factory("$ionicPopup", ["$ionicTemplateLoader", "$ionicBackdrop", "$q", "$timeout", "$rootScope", "$ionicBody", "$compile", "$ionicPlatform", function (e, t, n, i, o, r, a, c) {
            ...
            create: function (t, d, v, T, E, M) {
                var N, _, R, H = ++A, z = {
                    init: function (e, t) {
                        ...
                        for (n = 0, i = r.length; i > n && (o = r.eq(n), o.data(y) === c ? o.data(w) ? (o.data(y, c + ionic.Utils.nextUid()), o.data(b, !0)) : N = o : f(s) && o.data(y) === s && (_ = o), !N || !_); n++);
                        R = !!N, R || (N = e.ele || L.createViewEle(d), N.data(y, c)), M && t.activeEleId(c), e.ele = null
                    }, render: function (e, n) {
                        if (R)ionic.Utils.reconnectScope(N.scope()); else {
                            h(N, x);
                            var i = s(d, N, e.direction, v), r = o.transitions.views[i.transition] || o.transitions.views.none;
                            r(N, null, i.direction, !0).run(0), N.data(C, {
                                viewId: i.viewId,
                                historyId: i.historyId,
                                stateName: i.stateName,
                                stateParams: i.stateParams
                            }), (c(d).cache === !1 || "false" === c(d).cache || "false" == N.attr("cache-view") || 0 === o.views.maxCache()) && N.data(w, !0);
                            var a = t.appendViewElement(N, d);
                            delete i.direction, delete i.transition, a.$emit("$ionicView.loaded", i)
                        }
                        N.data(S, Date.now()), n && n()
                    }, transition: function (a, c, f) {
                        function p() {
                            h(N, F.shouldAnimate ? "entering" : B), h(_, F.shouldAnimate ? "leaving" : I), F.run(1), r._instances.forEach(function (e) {
                        ...
                        function b() {
                            b.x || (b.x = !0, N.off($, w), e.cancel(N.data(k)), _ && e.cancel(_.data(k)), z.emit("after", O, U), C && C.resolve(t), H === A && (n.all(P).then(L.transitionEnd), z.cleanup(O)), r._instances.forEach(function (e) {
                        ...
                        function S() {
                            h(N, I), h(_, B), N.off($, y), e.cancel(N.data(k)), L.transitionEnd([t])
                        }

                        var C, O = s(d, N, a, v), U = u(u({}, O), l(T));
                        O.transitionId = U.transitionId = H, O.fromCache = !!R, O.enableBack = !!c, O.renderStart = E, O.renderEnd = M, V(N.parent(), "nav-view-transition", O.transition), V(N.parent(), "nav-view-direction", O.direction), e.cancel(N.data(k));
                        var q = o.transitions.views[O.transition] || o.transitions.views.none, F = q(N, _, O.direction, O.shouldAnimate && f && M);
                        if (F.shouldAnimate && (N.on($, w), N.data(k, e(b, D)), i.show(D)), E && (z.emit("before", O, U), h(N, x), F.run(0)), M && (C = n.defer(), P.push(C.promise)), E && M)e(p, 16); else {
                            if (!M)return h(N, "entering"), h(_, "leaving"), {
                                run: F.run, cancel: function (t) {
                                    t ? (N.on($, y), N.data(k, e(S, D)), i.show(D)) : S(), F.shouldAnimate = t, F.run(0), F = null
                                }
                            };
                            M && p()
                        }
                        ...
                        var i = N.scope();
                        i && (i.$emit("$ionicView." + e + "Enter", t), "after" == e && i.$emit("$ionicView.enter", t)), _ ? (i = _.scope(), i && (i.$emit("$ionicView." + e + "Leave", n), "after" == e && i.$emit("$ionicView.leave", n))) : i && n && n.viewId && (i.$emit("$ionicNavView." + e + "Leave", n), "after" == e && i.$emit("$ionicNavView.leave", n))
                    }, cleanup: function (e) {
                        _ && "back" == e.direction && !o.views.forwardCache() && p(_);
        ...
        function p() {
            if (g)for (var e = 0; e < r._instances.length; e++)if (r._instances[e].$$delegateHandle == g)return r._instances[e];
            return t.inheritedData("$ionNavBarController")
        }

        var v, g, m, $, w, b = "$eleId", y = "$destroyEle", S = "$noCache", k = "active", C = "cached", T = this, B = !1, I = s.navViewAttr;
        T.scope = e, T.element = t, T.init = function () {
            var i = n.name || "", o = t.parent().inheritedData("$uiView"), r = o && o.state ? o.state.name : "";
            i.indexOf("@") < 0 && (i = i + "@" + r);
            var c = {name: i, state: null};
            t.data("$uiView", c);
            var s = a._registerInstance(T, n.delegateHandle);
            return e.$on("$destroy", function () {
                s(), T.isSwipeFreeze && d.freezeAllScrolls(!1)
            }), e.$on("$ionicHistory.deselect", T.cacheCleanup), e.$on("$ionicTabs.top", h), ionic.Platform.ready(function () {
                ionic.Platform.isWebView() && l.views.swipeBackEnabled() && T.initSwipeBack()
            }), c
        }, T.register = function (t) {
            var n = u({}, c.currentView()), i = c.register(e, t);
            T.update(i);
            var o = c.getViewById(i.viewId) || {}, r = $ !== i.viewId;
            T.render(i, t, o, n, r, !0)
        }, T.update = function (e) {
            B = !0, v = e.direction;
            var n = t.parent().inheritedData("$ionNavViewController");
            n && (n.isPrimary(!1), ("enter" === v || "exit" === v) && (n.direction(v), "enter" === v && (v = "none")))
        }, T.render = function (e, t, n, i, o, r) {
            var a = s.create(T, t, n, i, o, r);
            a.init(e, function () {
                a.transition(T.direction(), e.enableBack, !w), $ = w = null
            })
        }, T.beforeEnter = function (e) {
            if (B) {
                g = e.navBarDelegate;
                var t = p();
                t && t.update(e), f("")
            }
        }, T.activeEleId = function (e) {
            return arguments.length && (m = e), m
        }, T.transitionEnd = function () {
            var e, n, i, o = t.children();
            for (e = 0, n = o.length; n > e; e++)i = o.eq(e), i.data(b) === m ? I(i, k) : ("leaving" === I(i) || I(i) === k || I(i) === C) && (i.data(y) || i.data(S) ? s.destroyViewEle(i) : (I(i, C), ionic.Utils.disconnectScope(i.scope())));
            f(""), T.isSwipeFreeze && d.freezeAllScrolls(!1)
        }, T.cacheCleanup = function () {
            for (var e = t.children(), n = 0, i = e.length; i > n; n++)e.eq(n).data(y) && s.destroyViewEle(e.eq(n))
        }, T.clearCache = function () {
            for (var e, n, i = t.children(), o = 0, r = i.length; r > o; o++)e = i.eq(o), I(e) == C ? s.destroyViewEle(e) : I(e) == k && (n = e.scope(), n && n.$broadcast("$ionicView.clearCache"))
        }, T.getViewElements = function () {
            return t.children()
        }, T.appendViewElement = function (n, r) {
            var a = i(n);
            t.append(n);
            var c = e.$new();
            if (r && r.$$controller) {
            ...
            var t = p();
            t && t.title(e)
        }, T.enableBackButton = function (e) {
            var t = p();
            t && t.enableBackButton(e)
        }, T.showBackButton = function (e) {
            var t = p();
            t && t.showActiveBackButton(e)
        }, T.showBar = function (e) {
            var t = p();
            t && t.showBar(e)
        }, T.isPrimary = function (e) {
            return arguments.length && (B = e), B
        }, T.direction = function (e) {
            return arguments.length && (v = e), v
        }, T.initSwipeBack = function () {
            function n(e) {
                if (B && (S = r(e), !(S > C) && (v = c.backView(), v && v.historyId === c.currentView().historyId))) {
                    y || (y = window.innerWidth), T.isSwipeFreeze = d.freezeAllScrolls(!0);
                    var n = {direction: "back"};
                    k = [];
                    var a = s.create(T, n, v, c.currentView(), !0, !1);
                    a.loadViewElements(n), a.render(n), u = a.transition("back", c.enabledBack(v), !0), h = p(), m = ionic.onGesture("drag", i, t[0]), b = ionic.onGesture("release", o, t[0])
                }
            }
            ...
            function i(e) {
                if (B && u) {
                    var t = r(e);
                    if (k.push({t: Date.now(), x: t}), t >= y - 15)o(e); else {
                        var n = Math.min(Math.max(a(t), 0), 1);
                        u.run(n), h && h.activeTransition && h.activeTransition.run(n)
                    }
                }
            }
            ...
            function o(e) {
                if (B && u && k && k.length > 1) {
                    ...
                    var l = n >= k[k.length - 2].x, p = a(n), g = Math.abs(c.x - n) / (t - c.t);
                    if ($ = v.viewId, w = .03 > p || p > .97, l && (p > .5 || g > .1)) {
                        var S = g > .5 || .05 > g || n > y - 45 ? "fast" : "slow";
                        f(w ? "" : S), v.go(), h && h.activeTransition && h.activeTransition.complete(!w, S)
                    } else f(w ? "" : "fast"), $ = null, u.cancel(!w), h && h.activeTransition && h.activeTransition.cancel(!w, "fast"), w = null
                }
                ionic.offGesture(m, "drag", i), ionic.offGesture(b, "release", o), y = u = k = null, T.isSwipeFreeze = d.freezeAllScrolls(!1)
            }
            ...
            var u, h, v, g, m, b, y, S, k, C = l.views.swipeBackHitWidth();
            g = ionic.onGesture("dragstart", n, t[0]), e.$on("$destroy", function () {
                ionic.offGesture(g, "dragstart", n), ionic.offGesture(m, "drag", i), ionic.offGesture(b, "release", o), T.element = u = h = null
            })
        }
        ...
        u.on("scroll", g), e.$on("$destroy", function () {
            h(), d && d.__cleanup && d.__cleanup(), ionic.off("resize", p, i), i.removeEventListener("resize", p), u.off("scroll", g), d = s.scrollView = t = s._scrollViewOptions = t.el = s._scrollViewOptions.el = u = s.$element = l = null
        }), n(function () {
            d && d.run && d.run(), u.triggerHandler("scroll.init")
        ...
        m.$scope = e, m.initialize = function (e) {
            ...
            (m.left && m.left.isEnabled || m.right && m.right.isEnabled) && (m.close(), v !== e && ionic.trigger("resize", null, window), v = e, m.left && m.left.isEnabled ? m.content.setMarginLeft(v ? m.left.width : 0) : m.right && m.right.isEnabled && m.content.setMarginRight(v ? m.right.width : 0), m.$scope.$emit("$ionicExposeAside", v))
        ...
        o.tabs = [], o.selectedIndex = function () {
            ...
            e.$tabSelected && (r = i = null, e.$tabSelected = !1, (e.onDeselect || g)(), e.$broadcast && e.$broadcast("$ionicHistory.deselect"))
    ...
    l.directive("ionItem", function () {
        return {
            restrict: "E", controller: ["$scope", "$element", function (e, t) {
                this.$scope = e, this.$element = t
            }], scope: !0, compile: function (e, t) {
                var n = f(t.href) || f(t.ngHref) || f(t.uiSref), i = n || /ion-(delete|option|reorder)-button/i.test(e.html());
                if (i) {
                    var o = v(n ? P : D);
                ...
                return function (e, t, n) {
                    ...
                    var i = t[0].querySelector(".item-content");
                    i && e.$on("$collectionRepeatChange", function () {
                        i && (i.style[ionic.CSS.TRANSFORM] = "translate3d(0,0,0)")
                    })
                }
            }
        }
    ...
    var M = '<div class="item-options invisible"></div>';
        ...
        return {
            restrict: "E", require: "^ionItem", priority: Number.MAX_VALUE, compile: function (t, n) {
                return n.$set("class", (n["class"] || "") + " button", !0), function (t, n, i, o) {
                    o.optionsContainer || (o.optionsContainer = v(M), o.$element.append(o.optionsContainer)), o.optionsContainer.append(n), o.$element.addClass("item-right-editable"), n.on("click", e)
                }
            }
        }
    }]);
                ...
                function r(r, a, c, s) {
                    ...
                    var m = {
                        element: i[0], onDrag: function () {
                            ...
                            e ? (e = parseInt(e, 10), a[0].style[ionic.CSS.TRANSFORM] = "translate3d(" + e + "px,0,0)", a[0].style.width = n.innerWidth - e + "px", m.offsetX = e) : (a[0].style[ionic.CSS.TRANSFORM] = "translate3d(0,0,0)", a[0].style.width = "", m.offsetX = 0), ionic.trigger("resize", null, window)
            ...
            restrict: "E", scope: !0, controller: "$ionicTabs", compile: function (n) {
                function i(t, n, i, o) {
                    function a(e, t) {
                        e.stopPropagation();
                        var n = o.selectedTab();
                        n && n.$emit(e.name.replace("NavView", "View"), t)
                    }
